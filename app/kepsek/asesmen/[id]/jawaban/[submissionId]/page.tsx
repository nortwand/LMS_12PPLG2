...
export default function KepsekDetailJawabanSiswaPage() {
  ...
  if (loading) return <KepsekShell><p className="mx-auto max-w-7xl px-4 text-sm text-[#9CA3AF] sm:px-6">Memuat jawaban siswa...</p></KepsekShell>;
  if (error || !detail) {
    return (
      <KepsekShell><div className="flex flex-col items-center gap-3 py-10">
